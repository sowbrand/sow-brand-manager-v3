...
const Production: React.FC = () => {
  ...
  const BUTTON_PRIMARY = "bg-sow-green text-white px-6 py-3 rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-green-100 hover:bg-green-600 transition-colors active:scale-95";

  useEffect(() => {
    localStorage.setItem('sow_orders', JSON.stringify(orders));
  }, [orders]);
              ...
              <div className="bg-white rounded-xl shadow-xl w-full max-w-lg p-6 animate-in fade-in zoom-in">
                  ...
                  <form onSubmit={handleCreateOrder} className="space-y-4">
                      ...
                      <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                          ...
                          <button type="submit" className={BUTTON_PRIMARY}>Criar Pedido</button>
                      </div>
                  </form>
              </div>
          </div>
